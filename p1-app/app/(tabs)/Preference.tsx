  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.innerContainer}>
        <View>
          <Text style={{ color: '#FAF0E6', fontSize: 50, fontWeight: 'bold', fontFamily: 'AmaticSC-Bold' }}>
          ...
          {items.map((item, index) => (
           ...
           >
             {selectedItems.includes(index) ? (
               <ImageBackground source={item.image} style={styles.itemBackground} imageStyle={styles.imageStyle}>
        ...
        <View style={styles.complitedContainer}>
          <TouchableOpacity
            style={[
              styles.complitedButton,
              buttonClicked && styles.complitedButtonClicked,
            ]}
